...
model_path = '../../Output/regression_model.keras'
...
# TRAIN
#######
# Data Labeling - generate column ttf(Remaining Usefull Life or Time to Failure)
...
# we will only make use of "label_bnc" for binary classification, 
# while trying to answer the question: is a specific engine going to fail within w1 cycles?
w1 = 30
w0 = 15
train_df['label_bnc'] = np.where(train_df['ttf'] <= w1, 1, 0 )
train_df['label_mcc'] = train_df['label_bnc']
train_df.loc[train_df['ttf'] <= w0, 'label_mcc'] = 2
